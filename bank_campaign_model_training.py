...
bucket = storage_client.bucket("bucket-mlops-biyan")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "b-508911.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://bucket-mlops-biyan/data/bank-additional.csv"
    model_name='xgboost'
